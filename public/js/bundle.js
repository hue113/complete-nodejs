...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHVlcHQ5MiIsImEiOiJja2tzejZuMDgwY3Q4Mndxb3ZhcndvbjdyIn0.95arHl19VG6HRTnTF25L5g';
...
console.log('Hello from index.js'); //======= MAP =======
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              location.assign('/'); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1000);
            }
          ...
          case 7:
            ...
            showAlert('error', _context.t0.response.data.message); // console.log(err.response.data);
...
if (logOutBtn) logOutBtn.addEventListener('click', logout); //======= UPDATE =======
...
var stripe = Stripe('pk_test_51HzlQ4FD0x4Cf1q082I8zPeNMLHJAnc0Z9omFu6GVpvNlBvMpqIizld3SBGcUKyKTpNhYRqZxNhmzY3pxEMXf5Qa00hQiaolC5');
